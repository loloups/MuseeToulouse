...
<body>
<a href="#list-demandeVisite" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="list-demandeVisite" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="dateDebutPeriode"
                              title="${message(code: 'demandeVisite.dateDebutPeriode.label', default: 'Date Debut Periode')}"/>

            <g:sortableColumn property="dateFinPeriode"
                              title="${message(code: 'demandeVisite.dateFinPeriode.label', default: 'Date Fin Periode')}"/>

            <g:sortableColumn property="statut"
                              title="${message(code: 'demandeVisite.statut.label', default: 'Statut')}"/>

            <g:sortableColumn property="nbPersonnes"
                              title="${message(code: 'demandeVisite.nbPersonnes.label', default: 'Nb Personnes')}"/>
        ...
        <g:each in="${demandeVisiteInstanceList}" status="i" var="demandeVisiteInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${demandeVisiteInstance.id}">${fieldValue(bean: demandeVisiteInstance, field: "code")}</g:link></td>
